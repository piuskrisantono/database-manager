        ...
        <div class="content-box p-auto shadow-sm mx-3">
                <form  action="/dbrequest" method="POST">
                                    ...
                                    <table class="table table-bordered mt-3">
                                        ...
                                        <tbody id="listDisk">
                                          <tr id="firstDisk">
                                            ...
                                            <td><input id="firstDiskSize" type="number" step="5" class="form-control" name="requestedDiskSize[]"></td>
                                          ...
                                          <tr id="secondDisk" style="display: none;">
                                            ...
                                            <td><input id="secondDiskSize" type="number" step="5" class="form-control" name="requestedDiskSize[]"></td>
                                          ...
                                          <tr id="thirdDisk" style="display: none;">
                                            ...
                                            <td><input id="thirdDiskSize" type="number" step="5" class="form-control" name="requestedDiskSize[]"></td>
                                          ...
                                          <tr id="fourthDisk" style="display: none;">
                                            ...
                                            <td><input id="fourthDiskSize" type="number" step="5" class="form-control" name="requestedDiskSize[]"></td>
                  ...
                  <div class="d-flex flex-row-reverse mt-3">
                    <button type="submit" class="btn btn-primary" style="width:150px;"><i class="fa fa-plus"></i> Create Request</button>
                  </div>
